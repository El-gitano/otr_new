...
class ECDH:
	...
	def get_shared_secret(self, pubKey):
		return self.curve.scalar_mult(self.priv, pubKey)
		
	def get_serialized_shared_secret(self, pubKey):
		return self.get_shared_secret(pubKey)
...
assert commonAlice == commonBob

print('Shared secret: (0x{:x}, 0x{:x})'.format(*commonAlice))
