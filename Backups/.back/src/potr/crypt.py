...
class AuthKeyExchange(object):
	...
	# Génère le premier message de l'AKE
    def startAKE(self):
	...
	# Génère la réponse au message DHCommit
	...
	# Calcul de s, des clés MAC et des clés de chiffrement
    ...
    def checkPubkeyAuth(self, key, mackey, encsig):
        ...
        self.theirPubkey, auth = PK.parsePublicKey(auth) # Création d'une clé publique à partir de sa version serialisée
