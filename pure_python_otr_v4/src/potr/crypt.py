...
class ECDH:
	...
	def get_shared_secret(self, pubKey):
		...
		secretPoint = self.curve.scalar_mult(self.priv, pubKey)
		#result = HASH(pack_mpi(secretPoint[0]) + pack_mpi(secretPoint[1]))
		#print "Test SHA3 : {}".format(hexlify(HASH("abc".encode('ascii') )))
		#print "Result = {} et first byte : {}".format(hexlify(result), int(result[0], 16))
		return secretPoint[0]
